 ...
 *
 * The ZIP container itself is built by `@cairn/zip/testing`, and re-exported here so
 * the DOCX tests that predate the split keep importing it from one place.
 */
export { buildZip, type ZipEntryInput } from '@cairn/zip/testing';
import { buildZip } from '@cairn/zip/testing';
