...
whenever possible, do not route every request through an OSC backend, and implement
...
- **Proxy all GitHub traffic through OSC.** Rejected: bandwidth cost, a single shared
